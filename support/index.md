...
**How do I access my notebook server?**
Log in to Bryn, go to **Compute &rarr; Notebook servers**, launch a server, and click the URL provided. See the [quick start guide]({{ site.docs_site }}/6.Archive/notebook-servers/quick-start/) on docs.climb.ac.uk.

**What if I forget my two-factor authentication device?**
Use your backup codes if you set them up. If not, contact <a href="mailto:{{ site.support_email }}">{{ site.org_email }}</a>. See [Authentication]({{ '/getting-started/authentication/' | relative_url }}).
...
You'll receive notifications and may see restricted write access. Contact us to discuss increasing your quota.
