...
<div class="plan-grid">
  <div class="plan-card trial">
    ...
    <ul>
      <li>10 CPU (1:8 CPU:GB memory ratio)</li>
      <li>Flexible allocation between JuputerLab and Nextflow</li>
      <li>500GB team + 500GB S3</li>
    </ul>
  ...
  <div class="plan-card">
    ...
    <ul>
      ...
      <li>500 GB Team Shared + 500 GB S3</li>
...
<table>
  ...
  <tbody>
    <tr><td>CPU</td><td>Interactive JupyterLab / RStudio sessions / Nextflow / Pipeline execution on Kubernetes </td><td class="num">10 vCPU</td></tr>
    <tr><td>Memory</td><td>Paired with notebook CPU allocation; fixed 1:8 CPU:GB memory ratio</td><td class="num">80 GB</td></tr>
